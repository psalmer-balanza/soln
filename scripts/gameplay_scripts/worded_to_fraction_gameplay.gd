...
var fraction_questions = [
	...
	["I had a stock of potions. I used 3/8​ of them in the morning and 5/12 in the afternoon. How many potions did I use in total?", 3, 8, 5, 12],  # Second question fractions
	["I was baking pies. One pie was sliced into 3/6 ​, and another was sliced into 5/6​. How much pie do I have altogether?", 3, 6, 5, 6],  # Third question fractions
	]
